        ...
        <div class="col-50">
            ...
            <div class="col-50">
                <div class="details">
                    ...
                    <div class="price">
                        <h1 style="color:grey"> $<?php echo $arr['price'] ?></h1>
                    </div>

                    <div>
<!--                        <h4 style="color:white">Composition & Care</h4>-->
                        <p style="color:grey">
                            Ghungroo Design Indian Bahubali Boho Ethnic Party Retro Gold earrings<br>/
                            Bohemian Indian dangling Hook earrings is meant for your every occasion.<br>Wear and flaunt these Drop Dangle Chandbali
                            <br>Statement Dangler Contemporary earrings when you are in office,
                            college or when out with friends</p>
